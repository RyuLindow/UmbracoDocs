...
:::note
Do note that the IIS logging will be automatically turned off af 12 hours.  It's not possible to have them enabled for longer at once due to possible performance degradation while the IIS logging is enabled.
:::
